# Memoria del agente: digital-education-research-analyst

Este directorio contiene la memoria persistente acumulada por el agente `digital-education-research-analyst` a través de conversaciones.

## Índice de memorias

- [Perfil del usuario — Docente de posgrado DEDCP](user_docente_posgrado.md) — Submodo A doctoral; densidad alta; humanismo crítico; handoff a pipeline
